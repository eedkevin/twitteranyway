...
public class RenrenHttp 
{
	...
	*/
	...
	{
		//第一次向PLogin.do请求
		String postData = "email=" + userName + "&password=" + userPwd + "&origURL=http%3A%2F%2Fwww.renren.com%2FSysHome.do&domain=renren.com";
		...
		try
		{
			...
			URLConnection con = new URL("http://passport.renren.com/PLogin.do").openConnection();
			if(con != null)
			{
